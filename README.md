...
Looking at this this plot we can see that based on the data provided that the month of July seems to be the peak time that we experience an influx of immigrants to the United States. After seeing this I wanted to see where (what border) people are coming to America from, in essence where the encouters are tkaing place.
...
Since plotting this result, we can see overwhelmingly that most immigration is seen at the Southwest Border. Once relizing this, we can start to focus on a hypothesis of where or what countries people are coming to the Southwest Border from.
...
Fig 5. Display of apprehensions and when they started recording based on countries.

This graph allows us to see that CBP started taking into account the differnt countries immigrants were coming from, in about 2000. from there were able to see that there was a signifigant rise of immigrants who were From Mexico vs From Other Countries.
...
Fig 6. Overview of Code that compiles Independant T-Test
...
Fig 8. SARIMA Model that predicts based on training data, an uptick in apprehensions.
...
Fig 9. Auto ARIMA Model that forecasts a projection of predicted apprehensions.
...
Fig 10. ETS Forecasting Model on potential future border apprehensions.
...
Fig 11. Linear Regression Model making a prediction on increased apprehensions.
